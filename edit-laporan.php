<?php
    ...
    if (isset($_POST["tambahLaporan"]))
    {
            ...
            $laporan = mysqli_query($koneksi, "SELECT id_keterangan FROM tb_laporan_keterangan WHERE bulan_keterangan LIKE '%$bulan%'");

            $lapor = mysqli_fetch_all($laporan);

            $querr = mysqli_query($koneksi, "SELECT id FROM tb_laporan_bulan WHERE bulan LIKE '$bulan'");
...
<div class="container mt-5 col-7 shadow-sm">
    <div class="row">
        <div class="row justify-content-center">
            <div class="text-center">
                <p class="fs-4">Edit Laporan</p>
            </div>
            <form method="POST" action="">
             ...
             <div id="container">
                <table class="table">
                    ...
                    <input type='hidden' name="idKeterangan[]" require value="<?=$lapor[$i][0];?>">
...
<script src="js/edit-laporan.js"></script>
</body>
</html>